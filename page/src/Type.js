...
class Timer extends Component {
  ...
  tick() {
    if(this.state.onTick() !== undefined) {
      this.state.onTick();
    }
          ...
          <span className="timer">
            ...
            <b>
              <span ref={e => this.time = e}>
                <Timer ref={e => this.timer = e} time={this.state.time} onTick={() => this.setState({wpm: this.getWPM(), cpm: this.getCPM()})} onFinish={() => this.timerFinished()} render={(time) => (time)}/>
              </span>
            </b>
